using FloatTracker: TrackedFloat16, TrackedFloat32, write_out_logs, set_injector_config!, set_exclude_stacktrace!, set_logger_config!
using ShallowWaters

# run_model()
# run_model(TrackedFloat32)
set_logger_config!(filename="sh", buffersize=20, cstg=true, cstgArgs=false, cstgLineNum=false)
