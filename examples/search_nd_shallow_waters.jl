using FloatTracker: TrackedFloat16, TrackedFloat32, write_log_to_file, set_exclude_stacktrace!, set_logger_config!, write_out_logs
using ShallowWaters
...
for search_id = 0:20
  ...
  run1_name = set_logger_config!(filename="ndsh_id$search_id", buffersize=20, cstg=true, cstgArgs=false, cstgLineNum=false)
  ...
  run2_name = set_logger_config!(filename="ndsh_id$search_id", buffersize=20, cstg=true, cstgArgs=false, cstgLineNum=false)
  ...
  run3_name = set_logger_config!(filename="ndsh_id$search_id", buffersize=20, cstg=true, cstgArgs=false, cstgLineNum=false)
  ...
  run4_name = set_logger_config!(filename="ndsh_id$search_id", buffersize=20, cstg=true, cstgArgs=false, cstgLineNum=false)
